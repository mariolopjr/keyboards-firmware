...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   [0] = LAYOUT_ansi_blocker(
        ...
        KC_LCTL , KC_LALT, KC_LGUI,                            KC_SPC,                            KC_TRNS, MO(1)  ,          KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [1] = LAYOUT_ansi_blocker(
        QK_BOOT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,          SCL2   ,
